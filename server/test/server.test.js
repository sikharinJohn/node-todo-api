...
describe('DELETE /todos/:id', ()=>{
  it('should remove a todo and return doc', (done)=>{
  ...
  it('should not remove and return todo doc by other user', (done)=>{
...
describe('PATCH /todos/:id', ()=>{
  it('should update the todo', (done)=>{
    var hexId = todos[0]._id.toHexString();
    var update = { text: 'Update test Patch', completed: true};
  ...
  it('should clear completedAt when todo is not completed', (done)=>{
    var hexId = todos[1]._id.toHexString();
    var update = { text: 'Update test Patch 2', completed: false};
...
describe('POST /users', () =>{
  ...
  it('should not create user if email in use', (done) =>{
    request(app)
    .post('/users')
    .send({email: users[1].email, password: '12349888'})
    .expect(400)
    .expect( (res)=>{
    ...
    request(app)
      ...
      .end( (err,res)=>{
        ...
        User.findById(users[1]._id).then( (user)=>{
          expect.objectContaining(user.tokens[1],{
            'access': 'auth',
